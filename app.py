...
# ════════════════════════════════════════════════════════════
    ...
    prod_index = prod_index[prod_index["Revenue"]>1e8]
    ...
    for col in ["ROI","Revenue"]:
        ...
        prod_index[f"{col}_score"] = (prod_index[col]-mn)/(mx-mn)*100

    prod_index["Score"] = (
        prod_index["ROI_score"]*0.5 +
        prod_index["Revenue_score"]*0.5
    ).round(1)
    prod_index = prod_index.sort_values("Score", ascending=False).reset_index()
...
# ════════════════════════════════════════════════════════════
    ...
    monthly_z["Date"]  = pd.to_datetime(
        monthly_z["Yr"].astype(str)+"-"+monthly_z["Mo"].astype(str)+"-01")
